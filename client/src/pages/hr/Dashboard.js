...
const HRDashboard = () => {
  ...
  const stats = [
    { label: 'Total Jobs', value: totalJobs, change: 'Active posts', direction: 'up', color: 'purple' },
    { label: 'Total Applicants', value: totalApplicants, change: 'In pipeline', direction: 'up', color: 'teal' },
    { label: 'Interviews Scheduled', value: totalInterviews, change: 'Upcoming', direction: 'up', color: 'pink' },
    { label: 'Positions Filled', value: positionsFilled, change: 'Hired count', direction: 'up', color: 'yellow' },
  ];
