...
const CandidateDashboard = () => {
  ...
  const stats = [
    { label: 'Applications Sent', value: totalApplied, icon: '📄', color: 'purple' },
    { label: 'Under Review', value: underReview, icon: '🔍', color: 'teal' },
    { label: 'Interviews', value: interviews, icon: '📅', color: 'pink' },
    { label: 'Offers', value: offers, icon: '🎉', color: 'yellow' },
  ];
